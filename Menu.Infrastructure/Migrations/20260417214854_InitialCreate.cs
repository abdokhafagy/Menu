        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemImages_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemOptions_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    PriceModifier = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsDefault = table.Column<bool>(type: "bit", nullable: false),
                    DisplayOrder = table.Column<int>(type: "int", nullable: false),
                    ItemOptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OptionValues_ItemOptions_ItemOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemImages_MenuItemId",
                table: "ItemImages",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemOptions_MenuItemId",
                table: "ItemOptions",
                column: "MenuItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OptionValues_ItemOptionId",
                table: "OptionValues",
                column: "ItemOptionId");
